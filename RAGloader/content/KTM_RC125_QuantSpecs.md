...
# RC 125 — Quantitative Specifications (KTM)

This document is the structured, numeric-spec companion to the qualitative narrative document for the RC 125. Every field below is drawn directly from the KTM master dataset (all 1 trim(s)/variant(s) on record for this model). No field has been omitted; specs identical across all trims are stated once below, and specs that differ by trim are listed in the per-trim table.
...
- **Segment:** 125cc supersport (entry point to RC range)
...
- **Engine Type:** 4-Valve, Single Cylinder, Liquid Cooled, DOHC, FI
- **Cooling:** Liquid cooling, curved radiator with fans
- **Fuel System:** Bosch Electronic Fuel Injection
- **Max Power:** 14.5 PS @ 9,250 rpm (10.7 kW)
...
- **ABS Configuration:** Not listed as standard per brochure feature matrix (unlike RC 200/RC 390)
- **Front Tyre:** Not verified
- **Rear Tyre:** Not verified
- **Wheel Type:** Not verified
- **Instrument Cluster:** New LCD Dash Display
...
- **Single trim (as listed); also sold in GP Edition livery with identical mechanical spec — data completeness:** Dimensions, tyre sizes, transmission speed count, ARAI mileage, top speed, and acceleration not published in source brochures.
...
- **Single trim (as listed); also sold in GP Edition livery with identical mechanical spec:** power-to-weight ratio ≈ 66.9 W/kg (0.091 PS/kg).
