...
# RC 390 — Quantitative Specifications (KTM)

This document is the structured, numeric-spec companion to the qualitative narrative document for the RC 390. Every field below is drawn directly from the KTM master dataset (all 1 trim(s)/variant(s) on record for this model). No field has been omitted; specs identical across all trims are stated once below, and specs that differ by trim are listed in the per-trim table.

## Trims Covered (1)

- Single trim (as listed); also sold in GP Edition livery with identical mechanical spec

## Shared Specifications (identical across all trims above)

- **Segment:** 390cc supersport
...
- **Colours:** Orange, Blue, GP Edition (orange racing livery)
- **Displacement (cc):** 373.27
- **Engine Type:** Single Cylinder, Liquid Cooled, DOHC, FI
- **Cooling:** Liquid cooling, curved radiator with fans
- **Fuel System:** Bosch Electronic Fuel Injection
- **Max Power:** 43.5 PS @ 9,000 rpm (32 kW)
- **Max Torque:** 37 Nm @ 7,000 rpm
- **Transmission:** 6-speed (implied; not explicitly stated in spec table)
...
- **Ground Clearance (mm):** 153
- **Seat Height (mm):** 835
- **Kerb Weight (kg):** 172
- **Fuel Tank Capacity (L):** 13.7
- **Frame/Chassis:** Split-Trellis Frame (Tubular), newly engineered bolt-on subframe [T1, KTM India brochure]
- **Front Suspension:** WP APEX USD forks, 43mm diameter
- **Rear Suspension:** WP APEX Monoshock, 10-step adjustable
- **Front Brake:** 320mm disc, radially mounted caliper
- **Rear Brake:** 230mm disc, floating caliper
- **ABS Configuration:** Not verified
- **Front Tyre:** Not verified
- **Rear Tyre:** Not verified
- **Wheel Type:** Not verified
- **Instrument Cluster:** TFT Multifunction Display
- **Ride Modes:** Not verified
- **Connectivity Features:** Not verified
...
- **Single trim (as listed); also sold in GP Edition livery with identical mechanical spec — data completeness:** Dimensions (length/width/height/wheelbase), tyre sizes, transmission speed count, ARAI mileage, top speed, and acceleration not published in source brochures.
...
- **Single trim (as listed); also sold in GP Edition livery with identical mechanical spec:** power-to-weight ratio ≈ 186.0 W/kg (0.253 PS/kg).
