...
# 390 Adventure R — Quantitative Specifications (KTM)

This document is the structured, numeric-spec companion to the qualitative narrative document for the 390 Adventure R. Every field below is drawn directly from the KTM master dataset (all 1 trim(s)/variant(s) on record for this model). No field has been omitted; specs identical across all trims are stated once below, and specs that differ by trim are listed in the per-trim table.
...
- **Segment:** 390cc adventure-touring / off-road focused
...
- **Front Suspension:** WP APEX USD forks, 43mm, 230mm travel, fully adjustable compression/rebound (30 steps)
- **Rear Suspension:** WP APEX monoshock, 230mm travel, adjustable rebound (20 clicks) + preload (10 steps)
...
- **Single trim (as listed):** power-to-weight ratio ≈ 184.9 W/kg (0.251 PS/kg).
