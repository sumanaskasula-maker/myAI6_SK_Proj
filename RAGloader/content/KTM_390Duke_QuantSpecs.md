...
# 390 Duke — Quantitative Specifications (KTM)

This document is the structured, numeric-spec companion to the qualitative narrative document for the 390 Duke. Every field below is drawn directly from the KTM master dataset (all 1 trim(s)/variant(s) on record for this model). No field has been omitted; specs identical across all trims are stated once below, and specs that differ by trim are listed in the per-trim table.
...
- **Segment:** 390cc naked streetfighter
...
- **Colours:** Atlantic Blue, Slate Grey, Liquid Carbon
- **Displacement (cc):** 349.32
- **Engine Type:** 4-Stroke, Single Cylinder, DOHC, Liquid Cooled
- **Cooling:** Liquid cooled
- **Fuel System:** Electronic Fuel Injection
- **Max Power:** 41.5 PS @ 8600 rpm
- **Max Torque:** 33.5 Nm @ 7000 rpm
...
- **Ground Clearance (mm):** Not verified
- **Seat Height (mm):** Not verified
- **Kerb Weight (kg):** 168.3
- **Fuel Tank Capacity (L):** 15
- **Frame/Chassis:** Split-steel trellis frame [T1, KTM India brochure]
- **Front Suspension:** Adjustable front suspension (specific travel not published)
- **Rear Suspension:** Not verified
- **Front Brake:** 320 mm disc, radially mounted caliper
- **Rear Brake:** 240 mm disc, floating caliper
- **ABS Configuration:** Bosch dual-channel ABS w/ SuperMoto mode
- **Front Tyre:** Not verified
- **Rear Tyre:** Not verified
- **Wheel Type:** Alloy
- **Instrument Cluster:** TFT/LCD display with Bluetooth connectivity (model dependent)
- **Ride Modes:** Not verified
- **Connectivity Features:** Bluetooth connectivity via KTM app (model dependent — see per-model doc)
...
- **Single trim (as listed) — data completeness:** Dimensions, tyre sizes, ARAI mileage, top speed, and acceleration not published in source brochures.
...
- **Single trim (as listed):** power-to-weight ratio ≈ 181.3 W/kg (0.247 PS/kg).
